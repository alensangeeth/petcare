...
<body>
    <div class="container- position-relative bg-white d-flex p-0">
        ...
        <h2 class="text">All Services</h2>

          
            <div class="card-container">
          <?php while($row = $result->fetch_assoc()): ?>
        <div class="card">
            <img src="<?php echo $row['image']; ?>" alt="Service Image">
            <h2><?php echo $row['name']; ?></h2>
            <p><b>Description:</b> <?php echo $row['description']; ?></p>
            <p>$<?php echo $row['rate']; ?>/-</p>
         <div class="button-container">
            <a href="serviceupdate.php?id=<?php echo $row['id']; ?>" class="button">Update</a>
            <a href="servicedelete.php?id=<?php echo $row['id']; ?>" class="button" onclick="return confirm('Are you sure?')">Delete</a>
        </div>
        </div>
         <?php endwhile; ?>
        </div>
