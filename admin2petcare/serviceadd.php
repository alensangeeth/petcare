    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == UPLOAD_ERR_OK) {
        ...
        if (in_array($fileExtension, $allowedExtensions)) {
            ...
            if (move_uploaded_file($fileTmpPath, $uploadPath)) {
                ...
                echo "<script>alert('Error uploading the file');window.location.replace('serviceadd.php');</script>";
                exit;
            }
        } else {
            echo "<script>alert('Invalid file extension');window.location.replace('serviceadd.php');</script>";
            exit;
        }
    } else {
        echo "<script>alert('No file uploaded or error occurred');window.location.replace('serviceadd.php');</script>";
        exit;
    }

    // SQL query to insert teacher details
    $sql = "INSERT INTO service (name, description, rate, image) 
    VALUES ('$name', '$description', '$rate', '$image')";

if ($conn->query($sql) === TRUE) {
echo "<script>window.location.href = 'index.html';</script>";
exit;
} else {
echo "Error: " . $sql . "<br>" . $conn->error; // Displaying error details
}
}
?>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <link href="css/serviceadd.css" rel="stylesheet">
</head>
...
<body>
    <div class="container- position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="petorder.php" class="dropdown-item">Ordres</a>
        ...
        <div class="content">
            ...
            <div class="container">
        <h1>Add Service</h1>
        <form action="serviceadd.phpd" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" rows="4" placeholder="Enter your service description..." required></textarea>
            </div>
            <div class="form-group">
