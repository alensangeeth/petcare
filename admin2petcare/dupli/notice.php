                ...
                <div class="notice-board">
                    <div class="notice student-notice">
                        <div class="notice-header">
                            <p><strong>Notice Update Date:</strong><?php echo $row['tdate']; ?> </p>
                        </div>
                        <h2><?php echo $row['name']; ?></h2>
                        <p><strong>Program Date:</strong><?php echo $row['pdate']; ?></p>

                        <p><?php echo $row['description']; ?></p>
                        <button type="button"    <a href="noticeupdate.php?id=<?php echo $row['id']; ?>">Update</a></button>

                        <button type="button"  <a href="noticeupdate.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?')">Delete</a></button>
                        <?php endwhile; ?>
                    </div>
