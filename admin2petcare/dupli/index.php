        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="user.php" class="nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Students</a>
                    ...
                    <a href="notice.php" class="nav-item nav-link   "><i class="fa fa-tachometer-alt me-2"></i>Notice</a>
