...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <link href="css/viewdoc.css" rel="stylesheet">
</head>
...
<?php
        while($row=mysqli_fetch_array($result))
        {
            ...
            <img src="../admin2petcare/admin2petcare/<?php echo $row['image'];?>" alt="Pet Image">
            <h3> </h3>
            <p>Doctor Name:<?php echo $row['name'];?></p>
            <p>Specialized:<?php echo $row['department'];?> </p>
            <p>Experience:<?php echo $row['experience'];?> </p>
            <p>Available Time:<?php echo $row['time'];?> </p>
            <p>Available Date:<?php echo $row['date'];?> </p>
            <p>Fees:<?php echo $row['fees'];?> </p>
            <p class="pet-description">  </p>
        
            <div class="button-container">
                <button class="button edit-btn">Book Appoinment</button>
