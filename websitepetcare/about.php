                ...
                <div class="row">
                    <div class="offset-xl-1 col-lg-8">
                        <div class="about-details-cap mb-50">
                            <h4>Our Mission</h4>
                            <p>Our mission is to provide our customers with a great selection of high quality Pet Products and Pet Foods at the best price possible.
                            </p>
                            <p> </p>
                        </div>
                        ...
                        <div class="about-details-cap mb-50">
                            <h4>Our Vision</h4>
                            <p>Creating a world where pets and their families thrive together with ease and joy. We provide trusted resources, quality products, and a compassionate community to support pet owners in giving their pets the best life possible.
                            </p>
                            <p> </p>
                        </div>
                    </div>
            ...
            <div class="about-details">
                <div class="right-caption">
                    ...
                    <div class="about-more">
                        <p class="pera-top">Your trusted companion in pet care, offering premium products, expert advice, and a supportive community. We’re dedicated to making pet ownership easier and more joyful, helping you provide a happy, healthy life for your furry friends.<br></p>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            ...
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Hair Routines</span>
                                    <p>Dec 25, 5BC</p>
                                </div>
                                <h4>Hair Routine for Dogs tips from Alan Ship</h4>
                                <!-- <a href="a" class="read-more1">Read more</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            ...
                            <div class="blogs-cap">
                                ...
                                <h4>Vaccination Tips from Dr.Shambu </h4>
                                <!-- <a href="contact.html" class="read-more1">Read more</a> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            ...
                            <div class="blogs-cap">
                                ...
                                <h4>How to care your Dog tips From Niftty</h4>
                                <!-- <a href="/contact.html" class="read-more1">Read more</a> -->
                            </div>
                        </div>
                    </div>
